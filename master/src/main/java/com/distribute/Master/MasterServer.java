...
public class MasterServer {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Starting connection to zookeeper...");
		// 开启一个连接
		new CuratorHolder(MasterManager.ZK_HOST);
